                ...
                <div className='padding-x mt-24 absolute z-20 w-full'>
                    <div className='max-container flex justify-end'>
                        <div className='w-fit h-fit bg-gray-100 rounded-lg dark:bg-black max-lg:mr-[calc(25px+1rem)]'>
                            <span className={`flex gap-4 px-5 py-2 rounded-t-lg cursor-pointer hover:bg-gray-300 dark:hover:bg-gray-700 ${getTheme() === 'light' ? 'fill-coral-red text-coral-red' : 'fill-slate-gray text-slate-gray dark:fill-slate-100 dark:text-slate-100'}`} onClick={() => toggleLightMode()}>
                            ...
                            <span className={`flex gap-4 px-5 py-2 cursor-pointer hover:bg-gray-300 dark:hover:bg-gray-700 ${getTheme() === 'dark' ? 'fill-coral-red text-coral-red' : 'fill-slate-gray text-slate-gray dark:fill-slate-100 dark:text-slate-100'}`} onClick={() => toggleDarkMode()}>
                                <svg viewBox="0 0 384 512" width={24} height={24}>
                                    <path d="M223.5 32C100 32 0 132.3 0 256S100 480 223.5 480c60.6 0 115.5-24.2 155.8-63.4c5-4.9 6.3-12.5 3.1-18.7s-10.1-9.7-17-8.5c-9.8 1.7-19.8 2.6-30.1 2.6c-96.9 0-175.5-78.8-175.5-176c0-65.8 36-123.1 89.3-153.3c6.1-3.5 9.2-10.5 7.7-17.3s-7.3-11.9-14.3-12.5c-6.3-.5-12.6-.8-19-.8z" />
                                </svg>
                                Dark
                            </span>
                            <span className={`flex gap-4 px-5 py-2 rounded-b-lg cursor-pointer hover:bg-gray-300 dark:hover:bg-gray-700 ${getTheme() === 'system' ? 'fill-coral-red text-coral-red' : 'fill-slate-gray text-slate-gray dark:fill-slate-100 dark:text-slate-100'}`} onClick={() => toggleSystemMode()}>
